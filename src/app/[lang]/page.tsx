  ...
  return (
    <main className="h-screen">
      <div className="grid grid-cols-6 gap-1 h-full">
        ...
        <div className="bg-white col-span-6 sm:col-span-4 xl:col-span-5 flex items-start justify-start p-6">
          <p className="text-xl text-justify xl:h-64">
            {dictionary.aboutParagraph}
          </p>
        </div>
        <a
